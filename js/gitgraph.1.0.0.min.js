(function () {
  ...
  Branch.prototype.merge = function (target, commitOptions) {
    ...
    // Merge commit
    var defaultMessage = "Merge " + this.name; // + "` into `" + targetBranch.name + "`";
  ...
  Commit.prototype.render = function () {
    ...
    var commitOffsetLeft = (this.parent.columnMax + 1) * this.template.branch.spacingX + 5;// + commitOffsetForTags;
    ...
    if (this.tag !== null) {
      ...
      // Habing a tag do not modify the offset of commit info
    ...
    if (this.messageDisplay) {
      ...
      this.context.fillText(message, commitOffsetLeft-12, this.y + this.dotSize / 2);
    }
  };
  ...
  Template.prototype.get = function (name) {
    ...
    switch (name) {
      ...
      default:
        template = {
          // Repeat colors except grey
          colors: [ "#979797", "#008FB5", "#F1C109", "#FF220C", "#61E786", 
                    "#979797", "#008FB5", "#F1C109", "#FF220C", "#61E786"],
          branch: {
            lineWidth: 10,
            spacingX: 60,
            labelRotation: 0
...
// A utility function to draw a rectangle with rounded corners.
  ...
  function _drawTextBG(context, x, y, text, color, font, angle, useStroke) {
    ...
    if (useStroke) {
      context.beginPath();
      roundedRect(context,-(width / 2) - 4, -(height / 2)+10, width + 8, height - 5, 4);
